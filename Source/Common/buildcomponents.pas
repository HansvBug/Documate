...
begin
  ...
  _stringGrid.Options := _stringGrid.Options + [goEditing, goAutoAddRows, goTabs];
...
begin
  ...
  if aName.Contains('BitButtonAdd_') then begin
//    _bitButton.OnClick := @FormMain.FrmMain.BitButtonAddOnClick;
  end;
