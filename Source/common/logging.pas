...
type
  ...
  private
    ...
    procedure   WriteToLog(const LogText : String);                 //Tekst naar logbestand schrijven
    procedure   WriteToLogAndFlush(const LogText : String);         //Tekst direct naar logbestand schrijven
  ...
  public
    ...
    procedure   WriteToLogInfo(const LogText : String);             //Tekst naar logbestand schrijven
    procedure   WriteToLogWarning(const LogText : String);          //Tekst naar logbestand schrijven
    procedure   WriteToLogError(const LogText : String);            //Tekst naar logbestand schrijven
    procedure   WriteToLogDebug(const LogText : String);            //Tekst naar logbestand schrijven

    procedure   WriteToLogAndFlushInfo(const LogText : String);     //Tekst direct naar logbestand schrijven
    procedure   WriteToLogAndFlushWarning(const LogText : String);  //Tekst direct naar logbestand schrijven
    procedure   WriteToLogAndFlushError(const LogText : String);    //Tekst direct naar logbestand schrijven
    procedure   WriteToLogAndFlushDebug(const LogText : String);    //Tekst direct naar logbestand schrijven
...
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : INFORMATION  | ' + LogText);
end;

procedure TLog_File.WriteToLogWarning(const LogText: String);
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : WARNING      | ' + LogText);
end;

procedure TLog_File.WriteToLogError(const LogText: String);
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : ERROR        | ' + LogText);
end;

procedure TLog_File.WriteToLogDebug(const LogText: String);
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : DEBUG        | ' + LogText);
end;

procedure TLog_File.WriteToLog(const LogText : String);
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' :              | ' + LogText);  //In de stringgrid gereed zetten
end;

procedure TLog_File.WriteToLogAndFlushInfo(const LogText: String);
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : INFORMATION  | ' + LogText);  //In de stringgrid gereed zetten
  Logging;
end;
...
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : WARNING      | ' + LogText);  //In de stringgrid gereed zetten
  Logging;
end;
...
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : ERROR        | ' + LogText);  //In de stringgrid gereed zetten
  Logging;
end;
...
begin
  CurrentTime;
  strlist.Add(szCurrentTime + ' : DEBUG        | ' + LogText);  //In de stringgrid gereed zetten
  Logging;
end;
